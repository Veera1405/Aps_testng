...
public class Helper implements Globalvariables {
	public static class WebActionHelperMethods {
		 ...
		 * System.getProperty("user.dir") + APS_contsant.Screen_Shot + filename +
		 * dateName() + "_.png";
		 * 
		...
		/*
		 * public static String dateName() { String dateName = new
		 * SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date()); return dateName;
		 * }
		 */
