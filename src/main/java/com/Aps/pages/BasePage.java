...
public class BasePage implements Globalvariables {
	...
	protected String Toastmassege(WebElement element, String errormassge) {

		try {
			String loginstatus = wait.until(ExpectedConditions.elementToBeClickable((element))).getText();

			if (loginstatus == errormassge) {
	...
	protected void WaituntillElementclickable(WebElement adminSettingBtn) {
		wait.until(ExpectedConditions.visibilityOf(adminSettingBtn));
	}
}
